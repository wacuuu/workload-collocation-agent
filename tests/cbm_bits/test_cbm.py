...
from rmi.cbm_bits import check_cbm_bits, get_min_cbm_bits, get_max_mask
...
class CbmTest(unittest.TestCase):
    ...
    @mock.patch('rmi.cbm_bits.get_max_mask')
    @mock.patch('rmi.cbm_bits.get_min_cbm_bits')
