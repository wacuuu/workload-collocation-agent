...
@pytest.mark.parametrize('requested_fraction,bar_weights,expected_variance', [
    ...
    ({CPU: 0.4, MEM: 0.4, MEMBW_READ: 0.6},
     {CPU: 1, MEM: 1, MEMBW_READ: 1}, approx(0.01, abs=0.01)),
    ({CPU: 0.4, MEM: 0.5, MEMBW_READ: 0.6},
     {CPU: 1, MEM: 1, MEMBW_READ: 1}, approx(0.01, abs=0.01)),
    ({CPU: 0.1, MEM: 0.5, MEMBW_READ: 0.6},
     {CPU: 1, MEM: 1, MEMBW_READ: 1}, approx(0.05, abs=0.01)),
    ({CPU: 0.1, MEM: 0.5, MEMBW_READ: 0.6},
     {CPU: 0, MEM: 1, MEMBW_READ: 1}, approx(0.02, abs=0.01)),
    ({CPU: 0.1, MEM: 0.5, MEMBW_READ: 0.6},
     {CPU: 0.5, MEM: 1, MEMBW_READ: 1}, approx(0.04, abs=0.01)),
])
